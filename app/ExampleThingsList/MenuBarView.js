define(function(require, exports, module) {
    ...
    function _createMenu() {
        ...
        this.filterIconSurf = new Surface({
            size: [35,35],
            content: '<img width="35" src="./img/ExampleThingsList/filter-icon.png"/>',
            properties: {
                padding: '5px'
            }
        });
        ...
        this.xIconSurf = new Surface({
            size: [40,40],
            content: '<img width="40" src="./img/ExampleThingsList/x-icon.png"/>',
            properties: {
                paddingTop: '0.4px',
                paddingLeft: '2.6px'
            }
        ...
        var questionIconSurf = new Surface({
            size: [40,40],
            content: '<img width="40" src="./img/ExampleThingsList/question-icon.png"/>',
            properties: {
                paddingTop: '2px',
                paddingRight: '50px'
            }
