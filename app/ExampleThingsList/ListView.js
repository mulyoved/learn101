define(function(require, exports, module) {
  ...
  function _createList() {
    ...
    for(var i = 0; i < listContents.length; i++) {
      ...
      content += '<img class="list-icon" width="30" src="img/ExampleThingsList/' + listContents[i].type.toLowerCase() + '-icon.png" />';
      content += '<div class="list-subject">' + listContents[i].subject + '</div>';
      content += '<span class="list-type">' + listContents[i]['type'] + '</span>';
      //muly: content += '<img class="list-arrow" width="20" src="img/ExampleThingsList/arrow-icon.png" />';
      content += '</div>';
