define(function(require, exports, module) {
    ...
    function _createStrips() {
        ...
        var iconContents = [
            {text: 'BAR', imageUrl: 'img/ExampleThingsList/faded-drink-icon.png', available: false},
            {text: 'BOOK', imageUrl: 'img/ExampleThingsList/book-icon.png', available: true},
            {text: 'FOOD', imageUrl: 'img/ExampleThingsList/food-icon.png', available: true},

            {text: 'IDEA', imageUrl: 'img/ExampleThingsList/idea-icon.png', available: true},
            {text: 'MOVIE', imageUrl: 'img/ExampleThingsList/movie-icon.png', available: true},
            {text: 'MUSIC', imageUrl: 'img/ExampleThingsList/faded-music-icon.png', available: false},
